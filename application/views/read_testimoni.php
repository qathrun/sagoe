		  ...
		  <div id="table-scroll" style="height:100%">
            <table class="table table-bordered data-table" cellpadding="0" cellspacing="0" style="width: 100%; height:100%">
              <thead>
                <tr>
				<th>id</th>
				<th>nama_testimoni</th>
				<th>email_testimoni</th>
				<th>isi</th>
				<th>action</th>
                </tr>
              </thead>
			...
			<tr><center>
			<td><?php echo $u->id ?></td>
			<td><?php echo $u->nama_isi ?></td>
			<td><?php echo $u->email_isi ?></td>
			<td><?php echo $u->testimoni_isi ?></td>
			<td>
                <?php echo anchor('MyController/hapus_testimoni/'.$u->id,'Hapus'); ?>
			</td>
			</center>
			</tr>
			<?php } ?>
