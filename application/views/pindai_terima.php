      ...
      <div class="span12" style="height:100%">
        ...
        <div class="widget-box" style="height:100%">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Database Reservasi Di Terima</h5>
          </div>
		...
		<tr><center>
			...
			<td>
                <?php echo anchor('MyController/hapus_terima/'.$u->no_ktp,'Hapus'); ?>
				<?php echo anchor('MyController/edit_terima/'.$u->no_ktp,'Edit'); ?>
			</td>
