...
<html lang="en">
<head>
<title>Database Reservasi Di Terima</title>
...
<div id="content-header">
  ...
  <h1>Halaman Edit Pembayaran Di Terima</h1>
</div>
    ...
    <div class="span6">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Edit Pembayaran Di Terima</h5>
        </div>
        <div class="widget-content nopadding">
		<?php foreach($pindai_terima as $u){ ?>
		<form action="<?php echo base_url('index.php/MyController/update_terima'); ?>" method="post" class="form-horizontal">
