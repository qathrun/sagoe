      ...
      <div class="widget-box">
		...
		<form action="<?php echo base_url(). 'index.php/MyController/tambah_admin'; ?>" method="post" class="form-horizontal"> 
              ...
              <label class="control-label"></label>
				<div class="controls">
                <input type="hidden" class="span11" name="jenis_paket" value="Platinum" />
              </div>
            </div>
			<div class="control-group">
              <label class="control-label"></label>
			...
			<div class="control-group">
              <label class="control-label">Jenis Tari 2</label>
              <div class="controls">
                <select name="tari_2">
				   <option value="Saman">Saman</option>                             
                   <option value="Ratoeh Duek">Ratoeh Duek</option>                             
			...
			<div class="control-group">
              <label class="control-label">Jenis Tari 3</label>
              <div class="controls">
                <select name="tari_3">
				   <option value="Saman">Saman</option>                             
                   <option value="Ratoeh Duek">Ratoeh Duek</option>                             
