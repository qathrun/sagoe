...
<html lang="en"> 
    <head> 
        <title>Reservasi Paket Basic | SAGOE</title>         
    </head>      
    <body> 
        <header id="header"> 
            <div class="container"> 
            ...
            <div class="navbar navbar-inverse" role="banner"> 
                <div class="container"> 
                    <div class="navbar-header"> 
                        ...
                        <a class="navbar-brand" href="<?php echo base_url('index.php/Welcome/home');?>"> <h1><img src="<?php echo base_url('gambar/images/logo.png');?>" alt="logo"></h1> </a> 
                    </div>                     
            ...
            <div class="col-md-4 col-sm-4"> 
                ...
                <form action="<?php echo base_url(). 'index.php/MyController/tambah'; ?>" method="post"> 
                    <table style="margin:20px auto;"> 
                        ...
                        <br> 
                        <input type="number_format" name="no_ktp" placeholder="no_ktp" class="form-control">
                        <br> 
                        <input type="date" name="tanggal_tampil" placeholder="tanggal_tampil" class="form-control">
                        <br> 
                        <input type="time" name="waktu_tampil" placeholder="waktu_tampil" class="form-control">
                        <br> 
                        <input type="text" name="lokasi_tampil" placeholder="lokasi_tampil" class="form-control">
                        <br> 
                        ...
                        <br>
                        <input type="hidden" value="" name="tari_2">
                    </input>                     
                    <input type="hidden" value="" name="tari_3">
                </input>                 
